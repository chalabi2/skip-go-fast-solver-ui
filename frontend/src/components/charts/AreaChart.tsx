...
const LegendItem = ({
  ...
  return (
    <li
      className={cx(
        "group inline-flex flex-nowrap items-center gap-1.5 whitespace-nowrap rounded px-2 py-1",
        "transition-opacity duration-200",
        hasOnValueChange
          ? "cursor-pointer hover:bg-vercel-card-hovered"
          : "cursor-default"
      )}
      onClick={(e) => {
        e.stopPropagation();
    ...
    >
      ...
      <p
        className={cx(
          ...
          // text color
          "text-vercel-foreground",
          hasOnValueChange && "group-hover:text-vercel-foreground",
          activeLegend && activeLegend !== name ? "opacity-40" : "opacity-100"
        )}
      >
        {name}
  ...
  return (
    <button
      ...
      className={cx(
        ...
        disabled
          ? "cursor-not-allowed text-vercel-secondary"
          : "cursor-pointer text-vercel-foreground hover:bg-vercel-card-hovered"
      )}
      disabled={disabled}
      onClick={(e) => {
        e.stopPropagation();
      ...
      >
        ...
        <ResponsiveContainer>
          ...
          >
            {showGridLines ? (
              <CartesianGrid
                className={cx("stroke-vercel-border stroke-1")}
                horizontal={true}
                vertical={false}
              />
            ) : null}
            <XAxis
              ...
              fill=""
              stroke=""
              className={cx("text-xs", "fill-vercel-secondary")}
              tickLine={false}
              axisLine={false}
              minTickGap={tickGap}
            >
              {xAxisLabel && (
                <Label
                  ...
                  offset={-20}
                  className="fill-vercel-foreground text-sm font-medium"
                >
                  {xAxisLabel}
                </Label>
              )}
